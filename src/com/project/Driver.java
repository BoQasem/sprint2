...
public class Driver extends User implements IDriver{
	...
	static ArrayList<String> areaDiscounts = new ArrayList<>();
	...
	public void addAreaDiscounts(String area) {
        areaDiscounts.add(area);
    }

	public static boolean checkAreaDicounts(String area){
		for(int i=0; i<areaDiscounts.size(); i++){
			if(area.equals(areaDiscounts.get(i)))
				return true; 
		}
		return false; 
	}
